          ...
          >
            <div className="flex items-start justify-between gap-2">
              <div className="flex-1">
                <p className="font-semibold text-zinc-900 dark:text-white text-sm">{scan.patientName}</p>
                <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-1">{scan.procedure}</p>
