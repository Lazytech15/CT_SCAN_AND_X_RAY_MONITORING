...
export default function CTScanForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await apiService.ctScans.create(apiData)
    ...
    <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-md p-8 border border-zinc-200 dark:border-zinc-700 space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">Patient Name</label>
            <input
              type="text"
              name="patientName"
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">Patient ID</label>
            <input
              type="text"
              name="patientId"
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">Scan Date & Time</label>
            <input
              type="datetime-local"
              name="scanDate"
      ...
      <div className="flex gap-4 pt-4">
        ...
        <button
          ...
          className="flex-1 bg-zinc-200 dark:bg-zinc-700 hover:bg-zinc-300 dark:hover:bg-zinc-600 text-zinc-900 dark:text-white font-semibold py-3 rounded-lg transition-colors"
        >
          Clear
        </button>
      </div>
